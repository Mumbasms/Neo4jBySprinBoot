...
public class DarkSpringBootApplication {
    private final static Logger log = LoggerFactory.getLogger(DarkSpringBootApplication.class);

    public static void main(String[] args) {
	SpringApplication.run(DarkSpringBootApplication.class, args);
	//System.exit(0);
    }
